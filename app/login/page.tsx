...
export default function LoginPage() {
    ...
    return (
        <div className="flex min-h-screen w-full items-center justify-center px-4 hero-gradient">
            <Card className="w-full max-w-sm glass dark:glass-dark border-none shadow-2xl">
                ...
                <CardFooter className="flex flex-col gap-2">
                    <div className="text-center text-sm text-muted-foreground">
                        ...
                        <Link href="/signup" className="underline underline-offset-4 text-primary font-semibold">
                            Create one
                        </Link>
                    </div>
                </CardFooter>
